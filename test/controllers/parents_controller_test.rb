...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference("Parent.count") do
      post parents_url, params: { parent: { email: @parent.email, is_admin: @parent.is_admin, name: @parent.name, password_digest: @parent.password_digest } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { email: @parent.email, is_admin: @parent.is_admin, name: @parent.name, password_digest: @parent.password_digest } }
