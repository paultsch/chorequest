...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference("Child.count") do
      post children_url, params: { child: { age: @child.age, name: @child.name, parent_id: @child.parent_id, pin_code: @child.pin_code } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { age: @child.age, name: @child.name, parent_id: @child.parent_id, pin_code: @child.pin_code } }
